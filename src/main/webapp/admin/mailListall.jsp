<%@page import="com.agjs.hotel.service.customer.CustomerServiceMailTableService"%>
<%@page import="com.agjs.hotel.bean.customer.CustomerServiceMailVO"%>
<%@page import="com.agjs.hotel.service.customer.CustomerServiceMailService"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
<%@ page import="java.util.*"%>
<%@ page import="com.agjs.hotel.dao.*"%>
